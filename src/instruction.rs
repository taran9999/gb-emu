...
impl Instruction {
    pub fn decode(opcode: u8) -> Instruction {
        match opcode {
            ...
            0x04 => Instruction::INC_r8(Op8::Reg(Reg8Symbol::B)),
            0x05 => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::B)),
            ...
            0x0C => Instruction::INC_r8(Op8::Reg(Reg8Symbol::C)),
            0x0D => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::C)),
            ...
            0x14 => Instruction::INC_r8(Op8::Reg(Reg8Symbol::D)),
            0x15 => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::D)),
            ...
            0x1C => Instruction::INC_r8(Op8::Reg(Reg8Symbol::E)),
            0x1D => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::E)),
            ...
            0x24 => Instruction::INC_r8(Op8::Reg(Reg8Symbol::H)),
            0x25 => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::H)),
            ...
            0x2C => Instruction::INC_r8(Op8::Reg(Reg8Symbol::L)),
            0x2D => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::L)),
            ...
            0x34 => Instruction::INC_r8(Op8::Addr(Reg16Symbol::HL)),
            0x35 => Instruction::DEC_r8(Op8::Addr(Reg16Symbol::HL)),
            ...
            0x3C => Instruction::INC_r8(Op8::Reg(Reg8Symbol::A)),
            0x3D => Instruction::DEC_r8(Op8::Reg(Reg8Symbol::A)),
...
impl fmt::Display for Instruction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::INC_r8(op) => write!(f, "INC {op}"),
            Self::DEC_r16(r) => write!(f, "DEC {:?}", r),
            Self::DEC_r8(op) => write!(f, "DEC {op}"),
